...
const DENTAL_SLIDES: Slide[] = [
  {
    ...
    image: {
      ...
      saturation: 100,
      overlayOpacity: 45,
      photographerName: "Jonathan Chng",
    },
    styles: {
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        subtitle: "Conceito 1",
        body: "Dar espaço para os elements respirarem guia os olhos do seu cliente para as ações mais importantes. Menos ruído visual significa maior foco no CTA.",
